 ...
 */
public class GuiaPrecisionOral extends TouchFlipper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vfGuiaEsp = (ViewFlipper) findViewById(R.id.vfGuiaPrecisionOral);
        vfGuiaMam = (ViewFlipper) findViewById(R.id.vfGuiaPrecisionOralMam);
        vfGuiaKiche = (ViewFlipper) findViewById(R.id.vfGuiaPrecisionOralKiche);
        initToolBar();
